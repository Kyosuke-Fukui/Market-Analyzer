...
<html lang="en">
  ...
  <body>
        ...
        <div>
          <fieldset>
            ...
            <form method="post" action="./select.php">
              ...
              <input type="hidden" name="strategy" value="GCDC">
              <input type="submit" value="グラフ表示">
            </form> 
          </fieldset>
        </div>
        <div id="btnarea">
          <button onclick="location.href='./Oscillator/main.php'">オシレーター戦略</button>
    ...
    <div id="bottom"> 
        ...
        <fieldset>
          ...
          <div>
            ...
            <div id="backtest-config">
              短期EMA <input id="p1" type="number" value="10" step="10" min="10"></input><br>
              長期EMA <input id="p2" type="number" value="20" step="10" min="20"></input><br>
      ...
      <div id="optimizer">
        ...
        （計算範囲）-------------------->
          ...
          <div id="opt-config">
            短期EMA: from <input id="opt-p11" type="number" value="10" step="10" min="10"></input>
            ...
            長期EMA: from <input id="opt-p21" type="number" value="20" step="10" min="20"></input>
    ...
    <script src="./GCDC/js/strategy.js"></script>
    <script src="./GCDC/js/function.js"></script>
    <script src="./GCDC/js/execution.js"></script>
    <script>
    //価格計算ページに遷移
      var window;
      function newwindow() {
